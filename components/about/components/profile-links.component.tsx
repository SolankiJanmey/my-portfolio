...
import AnimatedButton from "./moving-border";
import AdvancedAnimatedButton from "./moving-border";
import ProfessionalAnimatedButton from "./moving-border";
import { FlipWords } from "./flip-words";

const words = ["Frontend Engineer", "Fullstack Engineer", "Software Engineer"];
export function AboutLinks() {
  return (
    <div className="flex justify-center items-start h-[30rem] md:h-[30rem] lg:h-[40rem] xl:h-[40rem] 2xl:h-[40rem] flex-col px-4 ml-12">
      ...
      <p className="flex gap-4 mt-12 ">
        <ProfessionalAnimatedButton text="About Me" />
        <ProfessionalAnimatedButton text="My Work" />
      </p>
    </div>
  );
}
