...
export function ContactComponent() {
  ...
  return (
    <div
      className={` ${alice.className} max-w-[90rem] w-full mx-auto rounded-none md:rounded-2xl p-4 shadow-input grid grid-cols-1 lg:grid-cols-3`}
    >
      <div>
        <h2 className="font-bold text-neutral-900 text-xl md:text-4xl max-w-4xl text-left ">
          Get in touch
        </h2>
        <p className="text-lg max-w-lg mt-2 text-neutral-500">
      ...
      <div className="bg-gradient-to-r from-transparent via-black to-transparent my-8 h-[2px] w-full lg:rotate-90 lg:mt-[250px]" />
      <div className="flex flex-col gap-10">
        <div className="flex flex-col space-y-4">
          <h2 className="font-bold text-neutral-900 text-xl md:text-3xl max-w-3xl text-left ">
            Contact Details
          </h2>
          <a
          ...
          >
            ...
            <a className="text-neutral-500 text-sm hover:text-neutral-700">
              {EMAIL}
            </a>
            {/* <BottomGradient /> */}
          </a>
